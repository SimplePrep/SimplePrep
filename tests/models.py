...
class Comment(models.Model):
    ...
    user = models.ForeignKey('users.UserAccount', on_delete=models.CASCADE, related_name = 'comments')
...
class TestResult(models.Model):
    ...
    user = models.ForeignKey('users.UserAccount', on_delete=models.CASCADE, related_name ='test_results')
...
class UserAnswer(models.Model):
    ...
    class Meta:
        unique_together = ('test_result', 'questiion')
