...
const About = () => {
  ...
  return (
    <div className="px-6  lg:px-8 mt-20 md:mt-0">
      <div
      ...
      <motion.div
        ...
        ref={ref1}
      >
        <motion.div className="h-full w-full lg:w-[45%] py-12 sm:py-24 lg:py-24 flex flex-col justify-center" variants={itemVariants}>
        <div className="px-10 space-y-10">
            <div  className="flex items-center justify-center lg:justify-start">
                <div className="p-2 rounded-full border-[1px] border-slate-400 text-sm font-bold text-gray-700">
            ...
            <Link
                to="/login"
                className="px-6 py-3 bg-[#00df9a] text-white text-lg font-semibold rounded-full shadow-md hover:bg-[#00c088] transition-transform transform hover:-translate-y-1 duration-300 ease-in-out"
            >
                Get Started
            </Link>
            <Link to="/login" className="text-lg font-semibold text-gray-900 hover:text-[#00df9a] flex items-center transition duration-300 ease-in-out">
                Our Features
        ...
        <motion.div className="h-full w-full lg:w-[55%] flex flex-col items-center justify-center relative" variants={imageVariants}>
        <div className="relative w-96 h-96 mb-4">
            ...
            <div className="absolute top-0 -right-10 p-4 text-4xl font-bold text-[#00df9a]">+75%</div>

        <motion.div className="absolute -bottom-4 -left-28 transform translate-x-[-50%] translate-y-[-50%] bg-neutral-100 p-4 rounded-xl shadow-2xl border"
          variants={itemVariants}
        >
          <p className='text-black text-center text-sm '>Monthly Progress</p>
