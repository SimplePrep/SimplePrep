        ...
        <div className={`rounded-3xl w-[350px] ${isDarkMode ? 'bg-[#1d263b] text-white' : 'bg-slate-50 text-gray-800'}`}>
          ...
          <div className="flex flex-row justify-between">
              <button
                ...
                className={`h-full w-1/2 py-5 font-bold rounded-bl-3xl ${isDarkMode ? ' text-white ' : ' text-blue-400 hover:text-white '} hover:bg-blue-600 border-r-[1px] border-r-slate-400`}
              >
                Got it
              </button>
              <button
