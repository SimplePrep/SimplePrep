...
import { FaBook, FaClipboardList, FaChevronDown, FaChevronUp } from 'react-icons/fa';
...
const ChapterCard: React.FC<ChapterCardProps> = ({ chapter, isDarkMode, isActive, onToggle }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className={`mt-4 py-2 px-4 w-full ${isDarkMode ? 'bg-blue-600 hover:bg-blue-700' : 'bg-blue-500 hover:bg-blue-600'} text-white rounded-lg font-medium`}>
          Continue course
        </button>
      </div>
        ...
        {isActive ? <FaChevronUp /> : <FaChevronDown />}
          ...
          <div className="h-full w-full md:w-3/5 flex flex-col gap-5 px-4 md:px-12 py-10 justify-center">
            ...
            <div className="mt-5 flex items-center">
              <button className={`py-2 px-4 ${isDarkMode ? 'bg-blue-600 hover:bg-blue-700' : 'bg-blue-500 hover:bg-blue-600'} text-white rounded-lg font-medium`}>
                Continue course
              </button>
