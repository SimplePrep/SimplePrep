                        ...
                        <div className="my-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            {isLoading ? (
                                Array.from({ length: 9 }).map((_, index) => (
                                    <div key={index} className="p-6 bg-gray-300 rounded-lg border-2 border-gray-200 shadow-lg animate-pulse">
                                        <div className="h-6 bg-gray-400 mb-2 rounded w-1/4"></div>
                                        <div className="h-8 bg-gray-400 mb-4 rounded w-3/4"></div>
