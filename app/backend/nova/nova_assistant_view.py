    ...
    if request.method == 'POST':
        ...
        try:
            ...
            with client.beta.threads.runs.stream(
                ...
                instructions="You are helpful assistant in explaining topics to students interested in Digital SAT Reading topics. Whenever, user asks question, you should refer to instruction file provided to you.  Try to sound like tutor. Also, answer very briefly. Start the conversation in a friendly tone.",
